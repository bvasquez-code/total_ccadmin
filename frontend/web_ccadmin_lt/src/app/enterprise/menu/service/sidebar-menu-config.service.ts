    ...
    private readonly menuConfig: SidebarMenuConfigDto[] = [
        new SidebarMenuConfigDto({
            ...
            children: [
                ...
                { permission: "VT000001", label: "Ver producto en preventa", url: "enterprise/product/pages/viewproduct", urlShade: "enterprise/sale/pages/createpresale", isVisible: false },
        ...
        new SidebarMenuConfigDto({
            ...
            children: [
                ...
                { permission: "CJ000003", label: "Gestión de caja", url: "enterprise/cash/pages/opencashsession" },
                { permission: "CJ000003", label: "Gestión de caja", url: "enterprise/cash/pages/closecashsession", urlShade: "enterprise/cash/pages/opencashsession", isVisible: false },
        ...
        new SidebarMenuConfigDto({
            ...
            children: [
                ...
                { permission: "SI000003", label: "Administrar compania", url: "enterprise/store/pages/managecompany", urlShade: "enterprise/store/pages/liststore", isVisible: false },
