...
--
    ...
    ELSE
        ...
        IF NOT EXISTS (
            ...
            ALTER TABLE `presale_det_warehouse` ADD COLUMN `ProductUnitName` varchar(32) NOT NULL DEFAULT 'NIU' COMMENT 'Unidad visible usada al registrar el detalle' AFTER `NumUnit`;
        ...
        IF NOT EXISTS (
            ...
            ALTER TABLE `presale_det_warehouse` ADD COLUMN `ProductUnitFactor` int NOT NULL DEFAULT '1' COMMENT 'Factor usado al registrar el detalle' AFTER `ProductUnitName`;
