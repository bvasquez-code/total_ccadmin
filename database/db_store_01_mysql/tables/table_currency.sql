DROP PROCEDURE IF EXISTS `p_manage_currency`;

DELIMITER $$

CREATE PROCEDURE `p_manage_currency`()
BEGIN
...
--
        ...
        SELECT 'Tabla currency creada desde cero.' AS Mensaje;
    ...
    ELSE
        ...
        SELECT 'Tabla currency ya existe. No se realizaron cambios estructurales.' AS Mensaje;
...
-- Ejecutar y limpiar
CALL `p_manage_currency`();
DROP PROCEDURE `p_manage_currency`;
