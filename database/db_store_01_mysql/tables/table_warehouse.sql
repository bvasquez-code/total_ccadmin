DROP PROCEDURE IF EXISTS `p_manage_warehouse`;

DELIMITER $$

CREATE PROCEDURE `p_manage_warehouse`()
BEGIN
...
/*!40101 SET character_set_client = @saved_cs_client */;
        ...
        SELECT 'Tabla warehouse creada desde cero.' AS Mensaje;
    ...
    ELSE
        ...
        SELECT 'Tabla warehouse ya existe. No se realizaron cambios estructurales.' AS Mensaje;
...
-- Ejecutar y limpiar
CALL `p_manage_warehouse`();
DROP PROCEDURE `p_manage_warehouse`;
