DROP PROCEDURE IF EXISTS `p_manage_ubigeo_district`;

DELIMITER $$

CREATE PROCEDURE `p_manage_ubigeo_district`()
BEGIN
    ...
    AND table_name = 'ubigeo_district';
...
--
        ...
        SELECT 'Tabla ubigeo_district creada desde cero.' AS Mensaje;
    ...
    ELSE
        ...
        SELECT 'Tabla ubigeo_district ya existe. No se realizaron cambios estructurales.' AS Mensaje;
...
-- Ejecutar y limpiar
CALL `p_manage_ubigeo_district`();
DROP PROCEDURE `p_manage_ubigeo_district`;
