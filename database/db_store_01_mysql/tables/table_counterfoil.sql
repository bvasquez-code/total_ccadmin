DROP PROCEDURE IF EXISTS `p_manage_counterfoil`;

DELIMITER $$

CREATE PROCEDURE `p_manage_counterfoil`()
BEGIN
...
--
        ...
        SELECT 'Tabla counterfoil creada desde cero.' AS Mensaje;
    ...
    ELSE
        ...
        SELECT 'Tabla counterfoil ya existe. No se realizaron cambios estructurales.' AS Mensaje;
...
-- Ejecutar y limpiar
CALL `p_manage_counterfoil`();
DROP PROCEDURE `p_manage_counterfoil`;
