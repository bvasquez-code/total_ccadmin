...
BEGIN
    ...
    IF v_table_exists = 0 THEN
        ...
        CREATE TABLE `stock_entry_det` (
          ...
          CONSTRAINT `fk_stock_entry_det_unavailable_reason` FOREIGN KEY (`UnavailableReasonCode`) REFERENCES `business_config` (`ConfigCod`),
          CONSTRAINT `fk_stock_entry_det_resolved_in_reason` FOREIGN KEY (`ResolvedInReasonCode`) REFERENCES `business_config` (`ConfigCod`),
          CONSTRAINT `fk_stock_entry_det_resolved_out_reason` FOREIGN KEY (`ResolvedOutReasonCode`) REFERENCES `business_config` (`ConfigCod`),
          CONSTRAINT `fk_stock_entry_det_resolution_reason` FOREIGN KEY (`ResolutionReasonCode`) REFERENCES `business_config` (`ConfigCod`),
    ...
    ELSE
        ...
        IF NOT EXISTS (
            ...
            ALTER TABLE `stock_entry_det`
                ...
                ADD CONSTRAINT `fk_stock_entry_det_resolved_in_reason`
        ...
        IF NOT EXISTS (
            ...
            ALTER TABLE `stock_entry_det`
                ...
                ADD CONSTRAINT `fk_stock_entry_det_resolved_out_reason`
