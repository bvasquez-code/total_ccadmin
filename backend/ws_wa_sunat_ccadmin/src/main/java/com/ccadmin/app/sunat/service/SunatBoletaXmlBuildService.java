...
@Service
public class SunatBoletaXmlBuildService extends SunatXmlBuildSupport {
    ...
    public String buildXmlBoleta(SunatElectronicDocumentDto dto) {
        try {
            ...
            throw new IllegalArgumentException("No se pudo generar XML de boleta SUNAT: " + ex.getMessage(), ex);
        }
    }
