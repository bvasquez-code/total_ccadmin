...
class TransferStockDispatchServiceTest {
    ...
    @InjectMocks
    private TransferStockDispatchService dispatchService;

    @Test
    void shouldSubtractPhysicalAndTotalStockForRegularTransfer() throws Exception {
        ...
        List<KardexEntity> result = this.dispatchService.dispatchTransfer(
                "TF001",
                "S001",
                List.of(detail),
                "USER01"
        ...
        assertThat(operation.MovementEvent).isEqualTo(TransferConstants.KARDEX_ZONE_EVENT_DISPATCH);
        ...
        assertThat(kardex.TypeOperation).isEqualTo(TransferConstants.KARDEX_TYPE_OUT);
        assertThat(kardex.NumStockBefore).isEqualTo(50);
        assertThat(kardex.NumStockMoved).isEqualTo(10);
        assertThat(kardex.NumStockAfter).isEqualTo(40);
        assertThat(result).containsExactly(kardex);
    }

    @Test
    void shouldUseRequestSourceForTransferRequestDispatch() throws Exception {
        TransferRequestDetEntity detail = requestDetail(1, 8);
        this.mockNewMovement(50);
        ArgumentCaptor<KardexZoneOperationDto> operationCaptor =
                ArgumentCaptor.forClass(KardexZoneOperationDto.class);

        this.dispatchService.dispatchTransferRequest(
                "TR001",
                "S001",
                List.of(detail),
                "USER01"
    ...
    @Test
    void shouldNotDuplicateTotalKardexWhenDispatchEventAlreadyExists() throws Exception {
        TransferDetEntity detail = transferDetail(1, 10);
    ...
    void shouldChainRepeatedProductLinesFromFreshKardexBalance() throws Exception {
        ...
        assertThat(result.get(0).NumStockAfter).isEqualTo(40);
        assertThat(result.get(1).NumStockBefore).isEqualTo(40);
    ...
    private TransferDetEntity transferDetail(int itemNumber, int quantity) {
        ...
        detail.Variant = "0000";
        detail.WarehouseCodOrigin = "W001";
        detail.NumUnit = quantity;
        detail.NumUnitDispatch = quantity;
