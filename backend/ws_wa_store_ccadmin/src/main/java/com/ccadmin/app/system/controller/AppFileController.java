...
public class AppFileController {
    ...
    @GetMapping("findById")
    public ResponseEntity<ResponseWsDto> findById(@RequestParam String FileCod) {
        try {
            return new ResponseEntity<>(new ResponseWsDto(appFileService.findById(FileCod)), HttpStatus.OK);
        } catch (Exception ex) {
